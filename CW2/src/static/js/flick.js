...
$(function() {
	...
	* next album
	*/
	$('.navig-photo-stack').find('.next1').bind('click',function(){
	...
	* previous album
	*/
	$('.navig-photo-stack').find('.prev1').bind('click',function(){
	...
	*/
	function disableNavRight () {
		navR = false;
		$('.navig-photo-stack').find('.next1').addClass('disabled');
	}
	function disableNavLeft () {
		navL = false;
		$('.navig-photo-stack').find('.prev1').addClass('disabled');
	}

	function TempdisableNavRight () {
		navR = false;
		$('.navig-photo-stack').find('.next1').addClass('temp_disabled');
	}
	function TempdisableNavLeft () {
		navL = false;
		$('.navig-photo-stack').find('.prev1').addClass('temp_disabled');
	}

	function enableNavRight () {
		navR = true;
		$('.navig-photo-stack').find('.next1').removeClass('disabled').removeClass('temp_disabled');
	}
	function enableNavLeft () {
		navL = true;
		$('.navig-photo-stack').find('.prev1').removeClass('disabled').removeClass('temp_disabled');
	}		
